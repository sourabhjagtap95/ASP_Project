                    ...
                    <div class="well">
                        ...
                        <form id="form1" name="student_registration" action="#" method="post" runat="server" onsubmit="return formValidation()">
                                ...
                                <fieldset>
                                    ...
                                    <label><div class="inner-addon left-addon"><i class="glyphicon glyphicon-pencil"></i>
                                        <asp:TextBox type="text" ID="txt_prn" runat="server" class="form-control" name="prn" placeholder="9-digit PRN number" required="true"></asp:TextBox></div>
                                    </label>
                                ...
                                <asp:Panel runat="server" ID="area_hidden" Visible="False">
                                    <fieldset>
                                        ...
                                        <label><div class="inner-addon left-addon"><i class="glyphicon glyphicon-user"></i>
                                            <input type="text" name="firstname" id="text-fields" class="form-control" spellcheck="false" placeholder="First" onchange="return firstname_validation(firstname)" required /></div>
                                        </label>
                                        <label><div class="inner-addon left-addon"><i class="glyphicon glyphicon-user"></i>
                                            <input type="text" name="lastname" id="text1" class="form-control" spellcheck="false" placeholder="Last" onchange="return lastname_validation(lastname)" required /></div>
                                        </label>
                                    </fieldset>
                                    <fieldset>
                                        <legend>
                                        ...
                                        <label><div class="inner-addon left-addon"><i class="glyphicon glyphicon-user"></i>
                                            <input type="text" name="username" id="text2" class="form-control" spellcheck="false" placeholder="User Name" onchange="return username_validation(username)" required /></div>
                                        </label>
                                    </fieldset>
                                    <fieldset>
                                        <legend>
                                        ...
                                        <label><div class="inner-addon left-addon"><i class="glyphicon glyphicon-lock"></i>
                                            <input type="password" name="password" id="Password1" class="form-control" spellcheck="false" placeholder="Password" onchange="return password_validation(password)" required /></div>
                                        </label>
                                        <label><div class="inner-addon left-addon"><i class="glyphicon glyphicon-lock"></i>
                                            <input type="password" name="confirm_password" id="Password2" class="form-control" spellcheck="false" placeholder="Confirm Password" onchange="return check_pass(password,confirm_password)" required /></div>
                                        </label>
                                    </fieldset>
                                    <fieldset>
                                        <legend>
                                    ...
                                    <fieldset>
                                        ...
                                        <label><div class="inner-addon left-addon"><i class="glyphicon glyphicon-pencil"></i>
                                            <input id="text4" class="form-control" name="rollno" placeholder="Roll No." required="" type="text" /></div>
                                        </label>
                                    </fieldset>
                                    <fieldset>
                                        <legend>
                                        ...
                                        <label><div class="inner-addon left-addon"><i class="glyphicon glyphicon-envelope"></i>
                                            <input type="text" name="email" id="text5" class="form-control" spellcheck="false" placeholder="Email-id" onchange="return email_validation(email)" required></div>
                                        </label>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </fieldset>
                                    <fieldset>
                                        ...
                                        <label><div class="inner-addon left-addon"><i class="glyphicon glyphicon-earphone"></i>
                                            <input type="text" name="mobile" id="text6" class="form-control" spellcheck="false" placeholder="Mobile Number" onchange="return check_mobile(mobile)" required></div>
                                        </label>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </fieldset>
                                    <fieldset>
                                        ...
                                        <label><div class="inner-addon right-addon"><i class="glyphicon glyphicon-home"></i>
                                            <textarea placeholder="Address" name="address"></textarea></div>
                                        </label>
                                    </fieldset>
